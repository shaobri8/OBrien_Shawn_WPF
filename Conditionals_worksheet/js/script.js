...
// The next problem is finding out the price for a movie ticket. The first thing that we need to do is find out our
 // variables.

//The price of a ticket is $12, however this price varies by the time of showing and age of the customer, so these will
 // be our variables.

 // Now that our variables are set we need to create a prompt for the user.
